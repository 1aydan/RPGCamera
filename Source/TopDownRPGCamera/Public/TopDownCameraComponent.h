...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FTDCameraModeChanged, ETDCameraMode, NewMode);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FTDCameraZoomChanged, float, NewArmLength);
 ...
 */
UCLASS(ClassGroup = (Camera), meta = (BlueprintSpawnableComponent, DisplayName = "Top Down Camera"))
class TOPDOWNRPGCAMERA_API UTopDownCameraComponent : public USpringArmComponent
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Top Down Camera|Mode")
	ETDCameraMode CameraMode = ETDCameraMode::FollowTarget;

	/** If true, panning while in Follow mode automatically drops the camera into Free Roam. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Mode")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Mode", meta = (EditCondition = "bAutoReturnToTarget", ClampMin = "0.0", Units = "s"))
	float ReturnToTargetDelay = 2.5f;

	/** Actor the camera follows. Defaults to the component owner on BeginPlay. */
	UPROPERTY(BlueprintReadOnly, Category = "Top Down Camera|Mode")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Follow", meta = (ClampMin = "0.0"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Follow", meta = (ClampMin = "0.0", Units = "cm"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Follow", meta = (EditCondition = "bLeadTarget", ClampMin = "0.0", Units = "s"))
	float LeadTime = 0.25f;

	/** Maximum distance the lead offset may reach. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Follow", meta = (EditCondition = "bLeadTarget", ClampMin = "0.0", Units = "cm"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Follow", meta = (EditCondition = "bMouseInfluence", ClampMin = "0.0", ClampMax = "1.0"))
	float MouseInfluenceStrength = 0.25f;

	/** Maximum distance the cursor bias may push the focus point. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Follow", meta = (EditCondition = "bMouseInfluence", ClampMin = "0.0", Units = "cm"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Zoom", meta = (ClampMin = "1.0", Units = "cm"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Zoom", meta = (ClampMin = "0.0", Units = "cm"))
	float ZoomStep = 150.f;

	/** How quickly the arm length reaches the requested zoom. 0 = instant. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Zoom", meta = (ClampMin = "0.0"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Zoom", meta = (EditCondition = "bUseDiscreteZoomLevels", ClampMin = "2", ClampMax = "32"))
	int32 ZoomLevelCount = 5;

	/** Explicit arm lengths, closest first. Overrides ZoomLevelCount when non-empty. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Zoom", meta = (EditCondition = "bUseDiscreteZoomLevels"))
	TArray<float> CustomZoomLevels;

	/** Zoom level the camera starts on. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Zoom", meta = (EditCondition = "bUseDiscreteZoomLevels", ClampMin = "0"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|FOV")
	bool bManageFieldOfView = true;

	/** FOV used when it is not linked to zoom. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|FOV", meta = (EditCondition = "bManageFieldOfView", ClampMin = "5.0", ClampMax = "170.0", Units = "deg"))
	float DefaultFOV = 60.f;

	/** Widen or narrow the lens across the zoom range. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|FOV", meta = (EditCondition = "bManageFieldOfView"))
	bool bLinkFOVToZoom = false;

	/** FOV at MinArmLength (fully zoomed in). */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|FOV", meta = (EditCondition = "bManageFieldOfView && bLinkFOVToZoom", ClampMin = "5.0", ClampMax = "170.0", Units = "deg"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|FOV", meta = (EditCondition = "bManageFieldOfView && bLinkFOVToZoom"))
	FRuntimeFloatCurve FOVBlendCurve;

	/** How quickly FOV reaches its goal. 0 = instant. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|FOV", meta = (EditCondition = "bManageFieldOfView", ClampMin = "0.0"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Pitch", meta = (ClampMin = "-89.0", ClampMax = "89.0", Units = "deg"))
	float DefaultPitch = -55.f;

	/** Flatten the angle as the camera zooms in, steepen it as it zooms out. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Pitch")
	bool bLinkPitchToZoom = true;

	/** Pitch at MinArmLength (fully zoomed in). */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Pitch", meta = (EditCondition = "bLinkPitchToZoom", ClampMin = "-89.0", ClampMax = "89.0", Units = "deg"))
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Pitch", meta = (EditCondition = "bLinkPitchToZoom"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Yaw")
	ETDYawMode YawMode = ETDYawMode::Continuous;

	/** Yaw the camera rests at, and returns to when recentered. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Yaw", meta = (Units = "deg"))
	float DefaultYaw = 0.f;

	/** Degrees per second for continuous rotation (input of 1.0). */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Yaw", meta = (ClampMin = "0.0"))
	float YawSpeed = 180.f;

	/** Degrees per step in Stepped mode. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Yaw", meta = (ClampMin = "1.0", ClampMax = "180.0", Units = "deg"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Yaw", meta = (EditCondition = "bAutoRecenterYaw", ClampMin = "0.0", Units = "s"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Pan", meta = (ClampMin = "0.0"))
	float PanSpeed = 1600.f;

	/** Pan faster when zoomed out, slower when zoomed in. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Pan")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Pan", meta = (EditCondition = "bEnableEdgePan", ClampMin = "1.0"))
	float EdgePanBorderPixels = 24.f;

	/** Scales PanSpeed while edge panning. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Top Down Camera|Pan", meta = (EditCondition = "bEnableEdgePan", ClampMin = "0.0"))
	...
	UPROPERTY(BlueprintAssignable, Category = "Top Down Camera|Events")
	FTDCameraModeChanged OnCameraModeChanged;

	UPROPERTY(BlueprintAssignable, Category = "Top Down Camera|Events")
	FTDCameraZoomChanged OnZoomChanged;
